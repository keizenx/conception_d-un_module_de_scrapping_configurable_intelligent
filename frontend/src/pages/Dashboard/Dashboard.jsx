...
const Dashboard = () => {
    ...
    const { theme, toggleTheme } = useTheme(); // Accéder au thème et à la fonction de bascule
    ...
    useEffect(() => {
        if (chartRef.current && activityData.labels.length > 0) {
            ...
            const gridColor = style.getPropertyValue('--border');
            const tooltipBg = style.getPropertyValue('--bg-card');
            ...
            chartInstance.current = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        pointBorderColor: style.getPropertyValue('--bg-dark'),
                        pointBorderWidth: 2,
                        pointRadius: 5,
                        pointHoverRadius: 7
                    }]
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        tooltip: {
                            ...
                            borderColor: primaryColor,
                            borderWidth: 1,
                            titleColor: style.getPropertyValue('--text-primary'),
                            bodyColor: textColor,
                            padding: 12,
                            displayColors: false
                        }
