                    ...
                    if collection['items_preview']:
                        ...
                        for field in first_item['fields'][:4]:
                            if field['type'] == 'title':
                                ...
                                print(f"        - {field['type']}: {field['text'][:50]}...")
...
if __name__ == "__main__":
    ...
    for category, urls in test_sites.items():
        ...
        for url in urls:
            ...
            results[category].append({
                ...
                "collections_found": result['summary']['total_collections_found'] if result and result.get("success") else 0
            })
            print("\n")
    ...
    for category, category_results in results.items():
        ...
        success = sum(1 for r in category_results if r['success'] and r['collections_found'] > 0)
